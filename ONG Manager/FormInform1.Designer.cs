...
namespace ONG_Manager
{
	partial class FormInform1
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(290, 105);
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(615, 62);
			...
			this.groupBox8.Size = new System.Drawing.Size(948, 368);
			this.groupBox8.TabIndex = 34;
			this.groupBox8.TabStop = false;
			this.groupBox8.Text = "REPORTE";
			// 
			// groupBox2
			// 
			...
			this.Name = "FormInform1";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.Text = "FormInform1";
