...
namespace ONG_Manager
{
	partial class FormAlumnos2
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox1.Text = "ASIGNACIÓN DE CURSOS AL ALUMNO";
			// 
			// button2
			// 
			...
			this.button2.Text = "ASIGNAR CURSOS AL ALUMNO";
			...
			this.tbid.Location = new System.Drawing.Point(82, 28);
			this.tbid.Name = "tbid";
			...
			this.Name = "FormAlumnos2";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.Text = "FormAlumnos2";
